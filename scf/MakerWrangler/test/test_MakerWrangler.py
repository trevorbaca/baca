...
def test_MakerWrangler_01():
    ...
    assert maker_wrangler.directory_name == '/Users/trevorbaca/Documents/other/baca/scf/makers'
    assert maker_wrangler.has_directory
    assert maker_wrangler.has_initializer
    assert maker_wrangler.initializer_file_name == '/Users/trevorbaca/Documents/other/baca/scf/makers/__init__.py'
    assert maker_wrangler.package_importable_name == 'baca.scf.makers'
