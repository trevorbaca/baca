...
def test_MaterialPackageMakerWrangler_iteration_02():
    ...
    assert wrangler.list_score_internal_wrangler_target_package_importable_names() == []


def test_MaterialPackageMakerWrangler_iteration_03():

    assert 'PitchRangeInventoryMaterialPackageMaker' in \
        wrangler.list_visible_wrangled_package_short_names()
...
def test_MaterialPackageMakerWrangler_iteration_05():
    ...
    assert ('PitchRangeInventoryMaterialPackageMaker', 
        'pitch range inventory material package maker') in wrangler.list_wrangled_package_menuing_pairs()
...
def test_MaterialPackageMakerWrangler_iteration_07():
    ...
    assert 'PitchRangeInventoryMaterialPackageMaker' in wrangler.list_wrangled_package_spaced_names()
