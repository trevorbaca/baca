...
class MaterialPackageMakerWrangler(PackageWrangler):
    ...
    def get_wrangled_package_proxy(self, material_package_importable_name):
        import baca
    ...
    def make_material_proxy_class_file(self, material_proxy_name, generic_output_name):
        class_file_name = os.path.join(
            self.score_external_wrangler_target_package_importable_name, material_proxy_name, material_proxy_name + '.py')
    ...
    def make_material_proxy_interactively(self):
        ...
        if self.backtrack():
            return
        material_proxy_directory = os.path.join(self.score_external_wrangler_target_package_importable_name, material_proxy_name)
    ...
    def make_material_proxy_stylesheet(self, material_proxy_name):
        ...
        stylesheet_file_name = os.path.join(
            self.score_external_wrangler_target_package_importable_name, material_proxy_name, 'stylesheet.ly')
