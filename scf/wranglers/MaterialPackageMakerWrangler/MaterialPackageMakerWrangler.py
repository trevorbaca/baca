...
class MaterialPackageMakerWrangler(PackageWrangler):
    ...
    def make_material_proxy_class_file(self, material_proxy_name, generic_output_name):
        class_file_name = os.path.join(
            self.score_externalwrangler_target_package_importable_name, material_proxy_name, material_proxy_name + '.py')
    ...
    def make_material_proxy_initializer(self, material_proxy_name):
        initializer_file_name = os.path.join(
            self.score_externalwrangler_target_package_importable_name, material_proxy_name, '__init__.py')
    ...
    def make_material_proxy_interactively(self):
        ...
        if self.backtrack():
            return
        material_proxy_directory = os.path.join(self.score_externalwrangler_target_package_importable_name, material_proxy_name)
    ...
    def make_material_proxy_stylesheet(self, material_proxy_name):
        ...
        stylesheet_file_name = os.path.join(
            self.score_externalwrangler_target_package_importable_name, material_proxy_name, 'stylesheet.ly')
    ...
    def unimport_makers_package(self):
        self.remove_package_importable_name_from_sys_modules(self.score_externalwrangler_target_package_importable_name)
