...
def test_MusicSpecifierModuleProxyWrangler_read_only_attributes_01():
    ...
    assert wrangler.toplevel_wrangler_target_package_importable_name == 'baca.specifiers'
    assert wrangler.score_resident_wrangled_package_importable_name_prefix == 'mus.specifiers'
