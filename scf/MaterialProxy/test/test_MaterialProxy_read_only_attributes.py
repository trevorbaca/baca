...
def test_MaterialProxy_read_only_attributes_01():
    ...
    assert not material_proxy.has_user_input_handler
    ...
    assert material_proxy.output_data_module_file_name == \
...
def test_MaterialProxy_read_only_attributes_02():
    ...
    assert not smp.has_user_input_handler
    ...
    assert smp.output_data_module_file_name == \
