...
def test_PackageProxy_read_only_attributes_01():
    ...
    package_proxy = baca.scf.PackageProxy('baca.materials.red_sargasso')
    ...
    assert package_proxy.package_importable_name == 'baca.materials.red_sargasso'
    assert package_proxy.package_short_name == 'red_sargasso'
    assert package_proxy.package_spaced_name == 'red sargasso'
