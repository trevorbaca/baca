...
def test_PackageProxy_read_only_attributes_01():
    ...
    assert package_proxy.path_name == '/Users/trevorbaca/Documents/other/baca/materials/red_sargasso_measures'
    assert package_proxy.get_tag('foo') is None
    assert package_proxy.initializer_file_name == \
        '/Users/trevorbaca/Documents/other/baca/materials/red_sargasso_measures/__init__.py'
