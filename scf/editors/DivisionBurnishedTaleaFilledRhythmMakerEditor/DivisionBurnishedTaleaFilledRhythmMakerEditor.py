...
class DivisionBurnishedTaleaFilledRhythmMakerEditor(RhythmMakerEditor):

	### CLASS ATTRIBTUES ###

    target_manifest = TargetManifest(rhythmmakertools.DivisionBurnishedTaleaFilledRhythmMaker,
