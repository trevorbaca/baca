...
class TokenIncisedRestFilledTimeTokenMakerEditor(TimeTokenMakerEditor):

    ### CLASS ATTRIBUTES ###

    target_manifest = TargetManifest(timetokentools.TokenIncisedRestFilledTimeTokenMaker,
