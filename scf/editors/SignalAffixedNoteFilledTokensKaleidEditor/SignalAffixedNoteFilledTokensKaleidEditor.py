...
class TokenIncisedNoteFilledTimeTokenMakerKaleidEditor(KaleidEditor):

    ### CLASS ATTRIBUTES ###

    target_manifest = TargetManifest(handlers.kaleids.TokenIncisedNoteFilledTimeTokenMaker,
