...
class SignalAffixedNoteFilledTokensKaleidEditor(KaleidEditor):

    ### CLASS ATTRIBUTES ###

    target_class = kaleids.SignalAffixedNoteFilledTokens
    target_manifest = TargetManifest(kaleids.SignalAffixedNoteFilledTokens,
