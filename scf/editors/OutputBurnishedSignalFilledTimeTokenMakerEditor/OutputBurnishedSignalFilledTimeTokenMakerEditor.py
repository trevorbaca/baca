...
class OutputBurnishedSignalFilledTimeTokenMakerEditor(TimeTokenMakerEditor):

    ### CLASS ATTRIBUTES ###

    target_manifest = TargetManifest(timetokentools.OutputBurnishedSignalFilledTimeTokenMaker,
