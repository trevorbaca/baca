from abjad import *
from music import makeMeasures
...
def test_make_measures_02( ):
   ...
   for i, x in enumerate(t):
      ...
      if i == 0:
         ...
         assert x.duration == Rational(3, 8)
