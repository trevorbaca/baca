...
def test_no_empty_list_to_lone_divide( ):
   raises(ValueError, 'divide([ ], (3, 16))')

def test_no_zero_value_to_lone_divide( ):
   raises(ValueError, 'divide([0], (3, 16))')

def test_no_nonassignable_duration_to_lone_divide( ):
   raises(ValueError, 'divide([1], (5, 8))')

def test_no_zero_values_to_divide( ):
   raises(ValueError, 'divide([1, 1, 0, 1], (3, 16))')
