...
def test__make_accelerando_multipliers():
    ...
    durations = 4 * [abjad.ValueDuration(1)]
    multipliers = baca.rhythm._make_accelerando_multipliers(durations, 0.5)
    ...
    durations = 4 * [abjad.ValueDuration(1)]
    multipliers = baca.rhythm._make_accelerando_multipliers(durations, 1)
