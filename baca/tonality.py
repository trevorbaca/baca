...
class ChordSuspension:
    ...
    def _initialize_by_start_and_stop(self, start, stop):
        start = abjad.ScaleDegree(start)
        stop = abjad.ScaleDegree(stop)
        return start, stop
    ...
    @property
    def start(self) -> abjad.ScaleDegree:
        """
        Gets start.
    ...
    @property
    def stop(self) -> abjad.ScaleDegree:
        """
        Gets stop.
...
class RomanNumeral:
    ...
    def __init__(self, symbol="V7"):
        ...
        scale_degree = abjad.ScaleDegree(scale_degree)
    ...
    @property
    def bass_scale_degree(self) -> abjad.ScaleDegree:
        """
        ...
        bass_scale_degree %= 7
        bass_scale_degree += 1
        bass_scale_degree = abjad.ScaleDegree(bass_scale_degree)
    ...
    @property
    def root_scale_degree(self) -> abjad.ScaleDegree:
        """
...
def _analyze_incomplete_tonal_function(argument, key_signature):
    ...
    scale = abjad.Scale(key_signature)
