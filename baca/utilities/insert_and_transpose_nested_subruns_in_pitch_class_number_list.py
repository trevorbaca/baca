...
def insert_and_transpose_nested_subruns_in_pitch_class_number_list(
    ...
    '''Inserts and transposes nested subruns in `pitch_class_number_list`
    ...
    allow inspection of the structural changes to `notes` immediately after the
    function returns. For this reason most calls to this function will be
    followed by ``notes = sequencetools.flatten_sequence(notes)``:
