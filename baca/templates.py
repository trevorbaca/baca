    ...
    ..  container:: example
        ...
        ..  docs::
            ...
            <BLANKLINE>
                            ...
                            R1 * 3/8
            <BLANKLINE>
                            % [MusicVoiceOne measure 3]                                              %! COMMENT_MEASURE_NUMBERS
                            R1 * 1/2
            <BLANKLINE>
                            % [MusicVoiceOne measure 4]                                              %! COMMENT_MEASURE_NUMBERS
                            R1 * 3/8
            <BLANKLINE>
                        }
            ...
            <BLANKLINE>
                            ...
                            R1 * 3/8
            <BLANKLINE>
                            % [MusicVoiceTwo measure 3]                                              %! COMMENT_MEASURE_NUMBERS
                            R1 * 1/2
            <BLANKLINE>
                            % [MusicVoiceTwo measure 4]                                              %! COMMENT_MEASURE_NUMBERS
                            R1 * 3/8
            <BLANKLINE>
                        }
                    >>
