    ...
    ..  container:: example
        ...
        ..  docs::
            ...
            <BLANKLINE>
                            ...
                            - \baca-text-spanner-left-text "make_notes(repeat_ties=True)"            %! baca.rhythm_annotation_spanner():RHYTHM_ANNOTATION_SPANNER:baca.PiecewiseCommand._call(2)
...
class RegisterInterpolationCommand(scoping.Command):
    ...
    def __init__(
        ...
        *,
        ...
        measures: typings.SliceTyping = None,
        scope: scoping.ScopeTyping = None,
        selector: abjad.Expression = classes.Expression().select().plts(),
