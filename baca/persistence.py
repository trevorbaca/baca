...
..  container:: example
    ...
    ..  container:: example
        ...
        >>> text = abjad.format.left_shift_tags(text, 89)
        >>> lines = [_.strip('\n') for _ in text.split('\n')]
...
..  container:: example
    ...
    ..  container:: example
        ...
        >>> dictionary
        {'Music_Staff': [baca.Memento(context='Music_Voice', edition=None, manifest=None, prototype='baca.PersistentOverride', synthetic_offset=None, value=PersistentOverride(after=None, attribute='bar_extent', context='Staff', grob='BarLine', hide=None, value="#'(0 . 0)")), baca.Memento(context='Music_Voice', edition=None, manifest=None, prototype='baca.StaffLines', synthetic_offset=None, value=1), baca.Memento(context='Music_Voice', edition=Tag('-PARTS'), manifest=None, prototype='baca.BarExtent', synthetic_offset=None, value=1)], 'Score': [baca.Memento(context='Global_Skips', edition=None, manifest=None, prototype='abjad.TimeSignature', synthetic_offset=None, value='3/8')]}
