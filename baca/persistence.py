        ...
        ..  docs::
            ...
            <BLANKLINE>
                        ...
                        %@% \override Staff.Clef.color = ##f                                         %! REDUNDANT_CLEF_COLOR_CANCELLATION:baca.SegmentMaker._attach_color_literal(1)
                            \set Staff.forceClef = ##t                                               %! REDUNDANT_CLEF:_set_status_tag:baca.SegmentMaker._treat_persistent_wrapper(2):baca.clef():IndicatorCommand
                            R1 * 3/8                                                                 %! _call_rhythm_commands
...
..  container:: example
        ...
        ..  docs::
            ...
            <BLANKLINE>
                        ...
                        %@% \baca-not-yet-pitched-coloring                                           %! NOT_YET_PITCHED:baca.SegmentMaker._color_not_yet_pitched()
                            ...
                            \set Staff.shortInstrumentName =                                         %! REDRAWN_EXPLICIT_MARGIN_MARKUP:_set_status_tag:baca.SegmentMaker._treat_persistent_wrapper(3):baca.margin_markup():IndicatorCommand
    ...
    ..  container:: example
        ...
        ..  docs::
            ...
            <BLANKLINE>
                            % [Music_Voice measure 1]                                                %! baca.SegmentMaker._comment_measure_numbers()
                            \set Staff.shortInstrumentName =                                         %! REAPPLIED_MARGIN_MARKUP:_set_status_tag:baca.SegmentMaker._reapply_persistent_indicators(3):-PARTS
                            \markup { I+II }                                                         %! REAPPLIED_MARGIN_MARKUP:_set_status_tag:baca.SegmentMaker._reapply_persistent_indicators(3):-PARTS
                            \set Staff.instrumentName =                                              %! baca.SegmentMaker._clone_segment_initial_short_instrument_name()
                        ...
                        %@% \baca-not-yet-pitched-coloring                                           %! NOT_YET_PITCHED:baca.SegmentMaker._color_not_yet_pitched()
                            ...
                            \set Staff.shortInstrumentName =                                         %! REDRAWN_REAPPLIED_MARGIN_MARKUP:_set_status_tag:baca.SegmentMaker._treat_persistent_wrapper(3):baca.SegmentMaker._reapply_persistent_indicators(3):-PARTS
        ...
        ..  docs::
            ...
            <BLANKLINE>
                        ...
                        %@% \baca-not-yet-pitched-coloring                                           %! NOT_YET_PITCHED:baca.SegmentMaker._color_not_yet_pitched()
                            ...
                            \set Staff.shortInstrumentName =                                         %! REDRAWN_REDUNDANT_MARGIN_MARKUP:_set_status_tag:baca.SegmentMaker._treat_persistent_wrapper(3):baca.margin_markup():IndicatorCommand
        ...
        ..  docs::
            ...
            <BLANKLINE>
                        ...
                        %@% ^ \baca-explicit-indicator-markup "[“III+IV”]"                           %! EXPLICIT_MARGIN_MARKUP_ALERT:baca.SegmentMaker._attach_latent_indicator_alert()
                            ...
                            \markup { I+II }                                                         %! REDRAWN_EXPLICIT_MARGIN_MARKUP:_set_status_tag:baca.SegmentMaker._treat_persistent_wrapper(3):baca.margin_markup():-PARTS:IndicatorCommand
                        %@% \override Staff.InstrumentName.color = #(x11-color 'DeepSkyBlue2)        %! REDRAWN_EXPLICIT_MARGIN_MARKUP_COLOR:baca.SegmentMaker._attach_color_literal(2)
                            \set Staff.shortInstrumentName =                                         %! REDRAWN_EXPLICIT_MARGIN_MARKUP:_set_status_tag:baca.SegmentMaker._treat_persistent_wrapper(3):baca.margin_markup():-PARTS:IndicatorCommand
    ...
    ..  container:: example
        ...
        ..  docs::
            ...
            <BLANKLINE>
                    ...
                    %@% - \baca-metronome-mark-spanner-left-text 2 0 1 "90"                          %! REAPPLIED_METRONOME_MARK:_set_status_tag:baca.SegmentMaker._reapply_persistent_indicators(2):baca.SegmentMaker._attach_metronome_marks(2)
    ...
    ..  container:: example
        ...
        ..  docs::
            ...
            <BLANKLINE>
                    ...
                    %@% - \abjad-invisible-line                                                      %! REDUNDANT_METRONOME_MARK:_set_status_tag:baca.SegmentMaker._attach_metronome_marks(2)
                    %@% - \baca-metronome-mark-spanner-left-text 2 0 1 "112"                         %! REDUNDANT_METRONOME_MARK:_set_status_tag:baca.SegmentMaker._attach_metronome_marks(2)
                    %@% \bacaStartTextSpanMM                                                         %! REDUNDANT_METRONOME_MARK:_set_status_tag:baca.SegmentMaker._attach_metronome_marks(2)
...
..  container:: example
    ...
    ..  container:: example
        ...
        ..  docs::
            ...
            <BLANKLINE>
                            % [Music_Voice measure 2]                                                %! baca.SegmentMaker._comment_measure_numbers()
                            \override Staff.BarLine.bar-extent = #'(-2 . 2)                          %! REDUNDANT_BAR_EXTENT:_set_status_tag:-PARTS:IndicatorCommand
    ...
    ..  container:: example
        ...
        ..  docs::
            ...
            <BLANKLINE>
                        ...
                        \pageBreak                                                                   %! BREAK:IndicatorCommand
                        s1 * 3/8                                                                     %! baca.SegmentMaker._make_global_skips(1)
                    %@% - \abjad-dashed-line-with-arrow                                              %! REAPPLIED_METRONOME_MARK:_set_status_tag:baca.SegmentMaker._reapply_persistent_indicators(2):baca.SegmentMaker._attach_metronome_marks(2)
                    %@% - \tweak bound-details.left.text \markup {                                   %! REAPPLIED_METRONOME_MARK:_set_status_tag:baca.SegmentMaker._reapply_persistent_indicators(2):baca.SegmentMaker._attach_metronome_marks(2)
                    %@%     \concat                                                                  %! REAPPLIED_METRONOME_MARK:_set_status_tag:baca.SegmentMaker._reapply_persistent_indicators(2):baca.SegmentMaker._attach_metronome_marks(2)
                    %@%         {                                                                    %! REAPPLIED_METRONOME_MARK:_set_status_tag:baca.SegmentMaker._reapply_persistent_indicators(2):baca.SegmentMaker._attach_metronome_marks(2)
                    %@%             \large                                                           %! REAPPLIED_METRONOME_MARK:_set_status_tag:baca.SegmentMaker._reapply_persistent_indicators(2):baca.SegmentMaker._attach_metronome_marks(2)
                    %@%                 \upright                                                     %! REAPPLIED_METRONOME_MARK:_set_status_tag:baca.SegmentMaker._reapply_persistent_indicators(2):baca.SegmentMaker._attach_metronome_marks(2)
                    %@%                     accel.                                                   %! REAPPLIED_METRONOME_MARK:_set_status_tag:baca.SegmentMaker._reapply_persistent_indicators(2):baca.SegmentMaker._attach_metronome_marks(2)
                    %@%             \hspace                                                          %! REAPPLIED_METRONOME_MARK:_set_status_tag:baca.SegmentMaker._reapply_persistent_indicators(2):baca.SegmentMaker._attach_metronome_marks(2)
                    %@%                 #0.5                                                         %! REAPPLIED_METRONOME_MARK:_set_status_tag:baca.SegmentMaker._reapply_persistent_indicators(2):baca.SegmentMaker._attach_metronome_marks(2)
                    %@%         }                                                                    %! REAPPLIED_METRONOME_MARK:_set_status_tag:baca.SegmentMaker._reapply_persistent_indicators(2):baca.SegmentMaker._attach_metronome_marks(2)
                    %@%     }                                                                        %! REAPPLIED_METRONOME_MARK:_set_status_tag:baca.SegmentMaker._reapply_persistent_indicators(2):baca.SegmentMaker._attach_metronome_marks(2)
                    %@% \bacaStartTextSpanMM                                                         %! REAPPLIED_METRONOME_MARK:_set_status_tag:baca.SegmentMaker._reapply_persistent_indicators(2):baca.SegmentMaker._attach_metronome_marks(2)
    ...
    ..  container:: example
        ...
        ..  docs::
            ...
            <BLANKLINE>
                        ...
                        s1 * 3/8                                                                     %! baca.SegmentMaker._make_global_skips(1)
                        \bacaStopTextSpanMM                                                          %! baca.SegmentMaker._attach_metronome_marks(1)
                    %@% - \abjad-dashed-line-with-arrow                                              %! REDUNDANT_METRONOME_MARK:_set_status_tag:baca.SegmentMaker._attach_metronome_marks(2)
                    %@% - \tweak bound-details.left.text \markup {                                   %! REDUNDANT_METRONOME_MARK:_set_status_tag:baca.SegmentMaker._attach_metronome_marks(2)
                    %@%     \concat                                                                  %! REDUNDANT_METRONOME_MARK:_set_status_tag:baca.SegmentMaker._attach_metronome_marks(2)
                    %@%         {                                                                    %! REDUNDANT_METRONOME_MARK:_set_status_tag:baca.SegmentMaker._attach_metronome_marks(2)
                    %@%             \large                                                           %! REDUNDANT_METRONOME_MARK:_set_status_tag:baca.SegmentMaker._attach_metronome_marks(2)
                    %@%                 \upright                                                     %! REDUNDANT_METRONOME_MARK:_set_status_tag:baca.SegmentMaker._attach_metronome_marks(2)
                    %@%                     accel.                                                   %! REDUNDANT_METRONOME_MARK:_set_status_tag:baca.SegmentMaker._attach_metronome_marks(2)
                    %@%             \hspace                                                          %! REDUNDANT_METRONOME_MARK:_set_status_tag:baca.SegmentMaker._attach_metronome_marks(2)
                    %@%                 #0.5                                                         %! REDUNDANT_METRONOME_MARK:_set_status_tag:baca.SegmentMaker._attach_metronome_marks(2)
                    %@%         }                                                                    %! REDUNDANT_METRONOME_MARK:_set_status_tag:baca.SegmentMaker._attach_metronome_marks(2)
                    %@%     }                                                                        %! REDUNDANT_METRONOME_MARK:_set_status_tag:baca.SegmentMaker._attach_metronome_marks(2)
                    %@% \bacaStartTextSpanMM                                                         %! REDUNDANT_METRONOME_MARK:_set_status_tag:baca.SegmentMaker._attach_metronome_marks(2)
