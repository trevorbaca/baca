...
class SegmentMaker(abjad.SegmentMaker):
            ...
            for pleaf in abjad.iterate(voice).leaves(pitched=True):
                ...
                if pleaf not in instrument.pitch_range:
                    ...
                    if not self.do_not_color_out_of_range_pitches:
                        ...
                        literal = abjad.LilyPondLiteral(string)
                        abjad.attach(
                            literal, pleaf, tag=_site(inspect.currentframe())
                        )
    ...
    def _color_octaves_(self):
        ...
        for vertical_moment in vertical_moments:
            ...
            if pitchclasses.PitchClassSegment(pitch_classes).has_duplicates():
                ...
                for pleaf in pleaves:
                    abjad.attach(
                        markup, pleaf, tag=_site(inspect.currentframe())
                    )
    ...
    def _color_unpitched_notes(self):
        ...
        for pleaf in abjad.iterate(self.score).leaves(pitched=True):
            ...
            literal = abjad.LilyPondLiteral(string)
            tag_ = abjad.Tag(_site(inspect.currentframe()))
            tag_ = tag_.prepend(tag)
    ...
    def _color_unregistered_pitches(self):
        ...
        for pleaf in abjad.iterate(self.score).leaves(pitched=True):
            ...
            literal = abjad.LilyPondLiteral(string)
            abjad.attach(literal, pleaf, tag=_site(inspect.currentframe()))
        ...
        ..  container:: example
            ...
            ..  docs::
                ...
                <BLANKLINE>
                                        e'16                                                             %! baca.music
                <BLANKLINE>
                                        \baca-octave-warning                                             %! baca.SegmentMaker._color_octaves_()
                                        f'16                                                             %! baca.music
                                        - \tweak color #red                                              %! baca.SegmentMaker._color_octaves_()
                                        ^ \markup { OCTAVE }                                             %! baca.SegmentMaker._color_octaves_()
                <BLANKLINE>
                                        g'16                                                             %! baca.music
                <BLANKLINE>
                                        a'16                                                             %! baca.music
    ...
    def do_not_color_out_of_range_pitches(self) -> typing.Optional[bool]:
        ...
        ..  container:: example
            ...
            ..  docs::
                ...
                <BLANKLINE>
                                    % [Music_Voice measure 2]                                            %! baca.SegmentMaker._comment_measure_numbers()
                                    \baca-out-of-range-warning                                           %! baca.SegmentMaker._check_range()
                                    c16                                                                  %! baca.music
                <BLANKLINE>
                                    d'16                                                                 %! baca.music
                <BLANKLINE>
