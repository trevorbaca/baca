...
def rest_color(
    color: str,
    selector=lambda _: classes.Selection(_).rest(0),
) -> OverrideCommand:
    """
...
def rest_down(
    selector=lambda _: classes.Selection(_).rests(),
) -> OverrideCommand:
    r"""
...
def time_signature_extra_offset(
    pair: abjad.NumberPair,
    selector=lambda _: classes.Selection(_).hleaf(0),
) -> OverrideCommand:
    r"""
...
def time_signature_stencil_false(
    selector=lambda _: classes.Selection(_).hleaves(),
) -> OverrideCommand:
    """
