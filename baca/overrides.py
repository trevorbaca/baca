...
class OverrideCommand(scoping.Command):
    ...
    def _call(self, argument=None) -> None:
        ...
        if tag:
            tag = tag.append("baca.OverrideCommand._call(1)")
        else:
            tag = abjad.Tag("baca.OverrideCommand._call(1)")
        ...
        if tag:
            tag = tag.append("baca.OverrideCommand._call(2)")
        else:
            tag = abjad.Tag("baca.OverrideCommand._call(2)")
...
def rest_down(
    selector: abjad.SelectorTyping = classes.Expression().select().rests(),
) -> OverrideCommand:
    r"""
...
def rest_extra_offset(
    pair: abjad.NumberPair,
    selector: abjad.SelectorTyping = classes.Expression().select().rest(0),
) -> OverrideCommand:
    """
...
def time_signature_extra_offset(
    pair: abjad.NumberPair,
    selector: abjad.SelectorTyping = classes.Expression().select().hleaf(0),
) -> OverrideCommand:
    r"""
...
def time_signature_stencil_false(
    selector: abjad.SelectorTyping = classes.Expression().select().hleaves(),
) -> OverrideCommand:
    """
