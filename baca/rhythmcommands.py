    ...
    ..  container:: example
        ...
        ..  docs::
            ...
            <BLANKLINE>
                                ...
                                - \baca-text-spanner-left-text "make_monads('2/5 2/5 1/5')"          %! baca.rhythm_annotation_spanner():RHYTHM_ANNOTATION_SPANNER:baca.PiecewiseCommand._call(2)
...
def tacet(
    ...
    *,
    ...
    scoping.tag(abjad.tags.TACET_COLORING, command)
