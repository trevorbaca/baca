...
def arpeggio(
    *,
    selector: typings.Selector = 'baca.chead(0, exclude=baca.enums.HIDDEN)',
...
def breathe(
    *tweaks: abjad.LilyPondTweakManager,
    selector: typings.Selector = 'baca.pleaf(-1, exclude=baca.enums.HIDDEN)',
...
def hide_black_note_heads(
    *,
    selector: typings.Selector = 'baca.leaves(exclude=baca.enums.HIDDEN)',
...
def laissez_vibrer(
    *,
    selector: typings.Selector  = 'baca.ptail(0, exclude=baca.enums.HIDDEN)',
