...
def accent(
    *,
    selector: typings.Selector = 'baca.phead(0, exclude=baca.const.HIDDEN)',
...
def arpeggio(
    *,
    selector: typings.Selector = 'baca.chead(0, exclude=baca.const.HIDDEN)',
...
def breathe(
    *tweaks: abjad.LilyPondTweakManager,
    selector: typings.Selector = 'baca.pleaf(-1, exclude=baca.const.HIDDEN)',
...
def hide_black_note_heads(
    *,
    selector: typings.Selector = 'baca.leaves(exclude=baca.const.HIDDEN)',
...
def laissez_vibrer(
    *,
    selector: typings.Selector  = 'baca.ptail(0, exclude=baca.const.HIDDEN)',
