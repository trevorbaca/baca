...
class RhythmCommand(Command):
    ...
    def _check_rhythm_maker_input(self, rhythm_maker):
        if rhythm_maker is None:
            return
        prototype = (abjad.Selection, abjadext.rmakers.RhythmMaker)
    ...
    def _check_rhythm_maker_pattern_pairs(self, pairs):
        if not isinstance(pairs, collections.Sequence): 
            return False
        prototype = (abjad.Selection, abjadext.rmakers.RhythmMaker, type(self))
        for pair in pairs:
    ...
    def _make_rhythm(self, start_offset, time_signatures):
        ...
        if isinstance(rhythm_maker, abjad.Selection):
            ...
            if isinstance(rhythm_maker, abjadext.rmakers.RhythmMaker):
            ...
            for subsequence in labelled_divisions:
                ...
                if isinstance(rhythm_maker, type(self)):
                    ...
                    assert isinstance(rhythm_maker, abjadext.rmakers.RhythmMaker)
        ...
        if self.rewrite_meter:
            selections = abjadext.rmakers.DurationSpecifier._rewrite_meter_(
                selections,
                time_signatures,
        ...
        if self.rewrite_rest_filled:
            selections = abjadext.rmakers.DurationSpecifier._rewrite_rest_filled_(
                selections,
    ...
    def _tag_broken_ties(self, selections):
        if not isinstance(self.rhythm_maker, abjadext.rmakers.RhythmMaker):
            return
    ...
    def rhythm_maker(self) -> typing.Optional[rhythm_maker_typing]:
        ...
        ..  container:: example
            ...
            >>> rhythm_maker_1 = abjadext.rmakers.NoteRhythmMaker(
            ...     division_masks=[abjadext.rmakers.silence([0], 1)],
            ...     )
            >>> rhythm_maker_2 = abjadext.rmakers.TaleaRhythmMaker(
