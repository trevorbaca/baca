...
class SegmentMaker(abjad.SegmentMaker):
        ...
        for staff in abjad.iterate(self._score).components(abjad.Staff):
            for leaf in abjad.iterate(staff).leaves():
                ...
                if (build is None and
                    ...
                    self._end_staff_lines[name] = before_line_count
    ...
    def clefs(self):
        ...
        ..  container:: example
            ...
            >>> metadata = {}
            >>> metadata['end_clefs'] = {}
            >>> metadata['end_clefs']['MusicStaff'] = pair
            >>> lilypond_file = maker.run(
            ...     environment='docs',
    ...
    def instruments(self):
        ...
        ..  container:: example
            ...
            >>> metadata['end_instruments']['MusicStaff'] = 'piccolo'
            >>> lilypond_file = maker.run(
            ...     environment='docs',
            ...     previous_metadata=metadata,
            ...     )
        ...
        ..  container:: example
            ...
            >>> metadata = {}
            >>> metadata['end_instruments'] = {}
            >>> metadata['end_instruments']['MusicStaff'] = 'flute'
            >>> lilypond_file = maker.run(
            ...     environment='docs',
            ...     previous_metadata=metadata,
            ...     )
