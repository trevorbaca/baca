...
import os
import abjad
from baca.tools.get_next_file_number import get_next_file_number


def conditionally_save_incremental_pdf(output_directory, base_file_name):
    r'''Conditionally saves incremental PDF.
    '''
    ...
    if save.lower() == 'y':
        ...
        abjad.lilypondfiletools.save_last_pdf_as(next_full_file_name)
        message = 'saved as %s.'
