...
class LibraryNZ(object):
    ...
    def pervasive_trills_at_pitch(pitch, harmonic=None, selector=None):
        ...
        ..  container:: example
            ...
            ::
                ...
                ...         pitch=1,
                ...         selector=baca.select().pls_in_tuplet(1),
                ...         ),
                ...     baca.rests_around([2], [4]),
                ...     baca.tuplet_bracket_staff_padding(5),
                ...     counts=[1, 1, 5, -1],
    ...
    def register(start, stop=None, selector=None):
        ...
        ..  container:: example
            ...
            ::
                ...
                ...     'Voice 1',
                ...     [[0, 2, 10], [18, 16, 15, 20, 19], [9]],
                ...     baca.color(baca.select().leaves_in_tuplet(1)),
                ...     baca.register(
                ...         -6,
                ...         selector=baca.select().leaves_in_tuplet(1),
                ...         ),
    ...
    def scripts_down(selector=None):
        ...
        ..  container:: example
            ...
            ::
                ...
                ...     baca.accents(),
                ...     baca.rests_around([2], [4]),
                ...     baca.scripts_down(baca.select().leaves_in_tuplet(1)),
                ...     baca.tuplet_bracket_staff_padding(5),
                ...     counts=[1, 1, 5, -1],
                ...     time_treatments=[-1],
                ...     )
    ...
    def scripts_up(selector=None):
        ...
        ..  container:: example
            ...
            ::
                ...
                ...     baca.accents(),
                ...     baca.rests_around([2], [4]),
                ...     baca.scripts_up(baca.select().leaves_in_tuplet(1)),
                ...     baca.tuplet_bracket_staff_padding(5),
                ...     counts=[1, 1, 5, -1],
                ...     time_treatments=[-1],
                ...     )
    ...
    def slur(selector=None):
        ...
        ..  container:: example
            ...
            ::
                ...
                ...     'Voice 1',
                ...     [[0, 2, 10], [18, 16, 15, 20, 19], [9]],
                ...     baca.slur(baca.select().trimmed_run_in_tuplet(1)),
                ...     baca.slurs_down(),
                ...     baca.rests_around([2], [4]),
                ...     baca.tuplet_bracket_staff_padding(5),
                ...     counts=[1, 1, 5, -1],
    ...
    def slur_each_plt_run(start=None, stop=None):
        ...
        '''
        return baca.SpannerCommand(
            selector=baca.select().plt_runs()[start:stop],
            spanner=abjad.Slur(),
            )
    ...
    def slurs_down(selector=None):
        ...
        ..  container:: example
            ...
            ::
                ...
                ...     [[0, 2, 10], [18, 16, 15, 20, 19], [9]],
                ...     baca.slur_trimmed_run_in_each_tuplet(),
                ...     baca.slurs_down(baca.select().leaves_in_tuplet(1)),
                ...     baca.rests_around([2], [4]),
                ...     baca.tuplet_bracket_staff_padding(5),
                ...     counts=[1, 1, 5, -1],
                ...     time_treatments=[-1],
    ...
    def slurs_up(selector=None):
        ...
        ..  container:: example
            ...
            ::
                ...
                ...     [[0, 2, 10], [18, 16, 15, 20, 19], [9]],
                ...     baca.slur_trimmed_run_in_each_tuplet(),
                ...     baca.slurs_up(baca.select().leaves_in_tuplet(1)),
                ...     baca.stems_down(),
                ...     baca.rests_around([2], [4]),
                ...     baca.tuplet_bracket_staff_padding(5),
                ...     baca.tuplet_brackets_down(),
    ...
    def staccati(selector=None):
        ...
        ..  container:: example
            ...
            ::
                ...
                ...     'Voice 1',
                ...     [[0, 2, 10], [18, 16, 15, 20, 19], [9]],
                ...     baca.staccati(baca.select().plt_heads_in_tuplet(1)),
                ...     baca.rests_around([2], [4]),
                ...     baca.tuplet_bracket_staff_padding(5),
                ...     counts=[1, 1, 5, -1],
                ...     time_treatments=[-1],
    ...
    def stem_color(color='red', context_name=None, selector=None):
        ...
        ..  container:: example
            ...
            ::
                ...
                ...     baca.stem_color(
                ...         color='red',
                ...         selector=baca.select().trimmed_run_in_tuplet(1),
                ...         ),
                ...     baca.rests_around([2], [4]),
                ...     baca.tuplet_bracket_staff_padding(5),
                ...     counts=[1, 1, 5, -1],
    ...
    def stems_down(selector=None):
        ...
        ..  container:: example
            ...
            ::
                ...
                ...     [[0, 2, 10], [18, 16, 15, 20, 19], [9]],
                ...     baca.rests_around([2], [4]),
                ...     baca.stems_down(baca.select().leaves_in_tuplet(1)),
                ...     baca.stems_up(),
                ...     baca.tuplet_bracket_staff_padding(5),
                ...     counts=[1, 1, 5, -1],
                ...     time_treatments=[-1],
    ...
    def stems_up(selector=None):
        ...
        ..  container:: example
            ...
            ::
                ...
                ...     baca.rests_around([2], [4]),
                ...     baca.stems_down(),
                ...     baca.stems_up(baca.select().leaves_in_tuplet(n=1)),
                ...     baca.tuplet_bracket_staff_padding(5),
                ...     counts=[1, 1, 5, -1],
                ...     time_treatments=[-1],
                ...     )
    ...
    def sustain_pedal(selector=None):
        ...
        ..  container:: example
            ...
            ::
                ...
                ...     baca.rests_around([2], [4]),
                ...     baca.sustain_pedal(
                ...         selector=baca.select().leaves_in_tuplet(n=1),
                ...         ),
                ...     baca.sustain_pedal_staff_padding(4),
                ...     baca.tuplet_bracket_staff_padding(5),
                ...     counts=[1, 1, 5, -1],
        ...
        ..  container:: example
            ...
            ::
                ...
                ...     baca.rests_around([2], [4]),
                ...     baca.sustain_pedal(
                ...         selector=baca.select().leaves_in_tuplet(
                ...             n=1,
                ...             leak=abjad.Left,
                ...             ),
                ...         ),
        ...
        ..  container:: example
            ...
            ::
                ...
                ...     baca.rests_around([2], [4]),
                ...     baca.sustain_pedal(
                ...     selector=baca.select().leaves_in_each_tuplet(leak=abjad.Left),
                ...         ),
                ...     baca.sustain_pedal_staff_padding(4),
                ...     baca.tuplet_bracket_staff_padding(5),
                ...     counts=[1, 1, 5, -1],
    ...
    def tenuti(selector=None):
        ...
        ..  container:: example
            ...
            ::
                ...
                ...     'Voice 1',
                ...     [[0, 2, 10], [18, 16, 15, 20, 19], [9]],
                ...     baca.tenuti(baca.select().plt_heads_in_tuplet(n=1)),
                ...     baca.rests_around([2], [4]),
                ...     baca.tuplet_bracket_staff_padding(5),
                ...     counts=[1, 1, 5, -1],
                ...     time_treatments=[-1],
    ...
    def ties_up(selector=None):
        ...
        ..  container:: example
            ...
            ::
                ...
                ...     baca.stems_down(),
                ...     baca.tie_each(),
                ...     baca.ties_up(baca.select().leaves_in_tuplet(1)),
                ...     baca.tuplet_bracket_staff_padding(5),
                ...     counts=[1, 1, 5, -1],
                ...     time_treatments=[-1],
                ...     )
