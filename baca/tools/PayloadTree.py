...
class PayloadTree(abjad.abctools.AbjadObject):
    r'''Payload tree.
    ...
    ::
        ...
        >>> tree = baca.tools.PayloadTree(sequence)
    ...
    def __eq__(self, expr):
        ...
        ::
            ...
            >>> tree_1 = baca.tools.PayloadTree(sequence_1)
            >>> sequence_2 = [[0, 1], [2, 3], [4, 5], [6, 7]]
            >>> tree_2 = baca.tools.PayloadTree(sequence_2)
            >>> sequence_3 = [[0, 1], [2, 3], [4, 5]]
            >>> tree_3 = baca.tools.PayloadTree(sequence_3)
    ...
    def __repr__(self):
        ...
        ..  container:: example
            ...
            ::
                ...
                >>> sequence = [[0, 1], [2, 3], [4, 5], [6, 7]]
                >>> baca.tools.PayloadTree(sequence)
                PayloadTree([[0, 1], [2, 3], [4, 5], [6, 7]])
        ...
        Returns string.
        '''
        return abjad.abctools.AbjadObject.__repr__(self)
