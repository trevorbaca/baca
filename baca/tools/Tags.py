...
class Tags(abjad.Enumeration):
    ...
    REAPPLIED_DYNAMIC_SHADOW_COLOR = enum.auto()
    ...
    REAPPLIED_MARGIN_MARKUP_SHADOW_COLOR = enum.auto()
    REAPPLIED_MARGIN_MARKUP_SHADOW_COMMAND = enum.auto()
    ...
    REAPPLIED_METRONOME_MARK_SHADOW_COLOR = enum.auto()
    ...
    REAPPLIED_TIME_SIGNATURE_SHADOW_COLOR = enum.auto()
