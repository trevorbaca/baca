...
class Tags(abjad.Enumeration):
    ...
    EXPLICIT_INSTRUMENT_REDRAW_COLOR = enum.auto()
    EXPLICIT_INSTRUMENT_REDRAW_COMMAND = enum.auto()
    ...
    REAPPLIED_INSTRUMENT_REDRAW_COLOR = enum.auto()
    REAPPLIED_INSTRUMENT_REDRAW_COMMAND = enum.auto()
    ...
    REDUNDANT_INSTRUMENT_REDRAW_COLOR = enum.auto()
    REDUNDANT_INSTRUMENT_REDRAW_COMMAND = enum.auto()
    ...
    EXPLICIT_MARGIN_MARKUP_REDRAW_COLOR = enum.auto()
    EXPLICIT_MARGIN_MARKUP_REDRAW_COMMAND = enum.auto()
    ...
    REAPPLIED_MARGIN_MARKUP_COMMAND = enum.auto()
    REAPPLIED_MARGIN_MARKUP_REDRAW_COLOR = enum.auto()
    REAPPLIED_MARGIN_MARKUP_REDRAW_COMMAND = enum.auto()
    ...
    REDUNDANT_MARGIN_MARKUP_REDRAW_COLOR = enum.auto()
    REDUNDANT_MARGIN_MARKUP_REDRAW_COMMAND = enum.auto()
    ...
    EXPLICIT_METRONOME_MARK_REDRAW_COLOR = enum.auto()
    ...
    REAPPLIED_METRONOME_MARK_REDRAW_COLOR = enum.auto()
    ...
    REDUNDANT_METRONOME_MARK_REDRAW_COLOR = enum.auto()
    ...
    EXPLICIT_TIME_SIGNATURE_REDRAW_COLOR = enum.auto()
    ...
    REAPPLIED_TIME_SIGNATURE_REDRAW_COLOR = enum.auto()
    ...
    REDUNDANT_TIME_SIGNATURE_REDRAW_COLOR = enum.auto()
