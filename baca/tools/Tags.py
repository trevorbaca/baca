...
class Tags(abjad.Enumeration):
    ...
    REMINDER_CLEF_COLOR = enum.auto() 
    REMINDER_CLEF_COMMAND = enum.auto()
    REMINDER_CLEF_SHADOW_COLOR = enum.auto()
    REMINDER_CLEF_UNCOLOR = enum.auto()
    ...
    REMINDER_INSTRUMENT_CHANGE_COLORED_MARKUP = enum.auto()
    REMINDER_INSTRUMENT_CHANGE_MARKUP = enum.auto()
    REMINDER_INSTRUMENT_COLOR = enum.auto() 
    REMINDER_INSTRUMENT_COMMAND = enum.auto()
    REMINDER_INSTRUMENT_SHADOW_COLOR = enum.auto()
    REMINDER_INSTRUMENT_SHADOW_COMMAND = enum.auto()
    REMINDER_INSTRUMENT_UNCOLOR = enum.auto()
    ...
    REMINDER_MARGIN_MARKUP_CHANGE_COLORED_MARKUP = enum.auto()
    REMINDER_MARGIN_MARKUP_CHANGE_MARKUP = enum.auto()
    REMINDER_MARGIN_MARKUP_COLOR = enum.auto() 
    REMINDER_MARGIN_MARKUP_COMMAND = enum.auto()
    REMINDER_MARGIN_MARKUP_SHADOW_COLOR = enum.auto()
    REMINDER_MARGIN_MARKUP_SHADOW_COMMAND = enum.auto()
    REMINDER_MARGIN_MARKUP_UNCOLOR = enum.auto()
    ...
    REMINDER_STAFF_LINES_COLOR = enum.auto() 
    REMINDER_STAFF_LINES_COMMAND = enum.auto()
    REMINDER_STAFF_LINES_SHADOW_COLOR = enum.auto()
    REMINDER_STAFF_LINES_UNCOLOR = enum.auto()
