...
class LibraryAM(object):
    ...
    def accents(selector=None):
        ...
        ..  container:: example
            ...
            ::
                ...
                ...     'Voice 1',
                ...     [[0, 2, 10], [18, 16, 15, 20, 19], [9]],
                ...     baca.accents(baca.select_pitched_heads_in_tuplet(n=1)),
                ...     baca.rests_around([2], [4]),
                ...     baca.tuplet_bracket_staff_padding(5),
                ...     talea_counts=[1, 1, 5, -1],
                ...     time_treatments=[-1],
    ...
    def arpeggiate_down(pattern=None):
        r"""Arpeggiates collections down.

        ..  container:: example

            Arpeggiates all collections down:
        ...
        ..  container:: example
            ...
            ::
                ...
                ...     'Voice 1',
                ...     [[0, 2, 10], [18, 16, 15, 20, 19], [9]],
                ...     baca.arpeggiate_down(pattern=abjad.select_first()),
                ...     baca.rests_around([2], [4]),
                ...     baca.tuplet_bracket_staff_padding(5),
                ...     talea_counts=[1, 1, 5, -1],
                ...     time_treatments=[-1],
    ...
    def arpeggiate_up(pattern=None):
        r"""Arpeggiates collections up.

        ..  container:: example

            Arpeggiates all collections up and then octave-transposes the
            lowest note of each tuplet to octave 3:
        ...
        ..  container:: example
            ...
            Arpeggiates collection 0 up and octave-transposes such that lowest
            note apepars in octave 3:
            ...
            ::
                ...
                ...     'Voice 1',
                ...     [[0, 2, 10], [18, 16, 15, 20, 19], [9]],
                ...     baca.arpeggiate_up(pattern=abjad.select_first()),
                ...     baca.bass_to_octave(
                ...         3,
        ...
        ..  container:: example
            ...
            Regression: (trivially) up-arpeggiates chord pitch-classes:
    ...
    @staticmethod
    def beam_everything(stemlets=None):
        r'''Beams everything.
    ...
    def chord_spacing_down(
        ...
        r"""Spaces chords down.

        ..  container:: example

            Bass-spaces chords down:
    ...
    def clef(clef='treble', selector=None):
        ...
        ..  container:: example
            ...
            ::
                ...
                ...     baca.clef(
                ...         clef='alto',
                ...         selector=baca.select_leaf_in_tuplet(1, 0),
                ...         ),
                ...     baca.rests_around([2], [4]),
                ...     baca.tuplet_bracket_staff_padding(7),
                ...     talea_counts=[1, 1, 5, -1],
    ...
    def color(color='red', selector=None):
        ...
        ..  container:: example
            ...
            ::
                ...
                ...     'Voice 1',
                ...     [[0, 2, 10], [18, 16, 15, 20, 19], [9]],
                ...     baca.color(selector=baca.select_leaves_in_tuplet(1)),
                ...     baca.flags(),
                ...     baca.rests_around([2], [4]),
                ...     baca.tuplet_bracket_staff_padding(5),
                ...     talea_counts=[1, 1, 5, -1],
        ...
        '''
        return baca.tools.ColorSpecifier(
            color=color,
            selector=selector,
            )
    ...
    def cross_staff(selector=None):
        ...
        ..  container:: example
            ...
            ::
                ...
                ...         baca.anchor('Violin Music Voice'),
                ...         baca.cross_staff(
                ...             selector=baca.select_pitched_leaves(start=-2),
                ...             ),
                ...         baca.flags(),
                ...         baca.stems_up(),
                ...         figure_name='vn 2',
    ...
    def dynamics_down(selector=None):
        ...
        ..  container:: example
            ...
            ::
                ...
                ...         baca.select_pitched_head_in_tuplet(1, 0),
                ...         ),
                ...     baca.dynamics_down(baca.select_leaf_in_tuplet(1, 0)),
                ...     baca.rests_around([2], [4]),
                ...     baca.tuplet_bracket_staff_padding(5),
                ...     talea_counts=[1, 1, 5, -1],
                ...     time_treatments=[-1],
    ...
    def dynamics_up(selector=None):
        ...
        ..  container:: example
            ...
            ::
                ...
                ...         baca.select_pitched_head_in_tuplet(1, 0),
                ...         ),
                ...     baca.dynamics_up(baca.select_leaf_in_tuplet(1, 0)),
                ...     baca.rests_around([2], [4]),
                ...     baca.tuplet_bracket_staff_padding(5),
                ...     talea_counts=[1, 1, 5, -1],
                ...     time_treatments=[-1],
    ...
    def laissez_vibrer(selector=None):
        ...
        ..  container:: example
            ...
            ::
                ...
                ...     [[0, 2, 10], [18, 16, 15, 20, 19], [9]],
                ...     baca.laissez_vibrer(
                ...         baca.select_pitched_tails_in_tuplet(1),
                ...         ),
                ...     baca.rests_around([2], [4]),
                ...     baca.tuplet_bracket_staff_padding(5),
                ...     talea_counts=[1, 1, 5, -1],
        ...
        '''
        selector = selector or baca.select_pitched_tails()
        return baca.tools.ArticulationSpecifier(
    ...
    @staticmethod
    def messiaen_ties(selector=None):
        r'''Attaches Messaien ties to isopitched runs.

        ..  container:: example

            Attaches Messiaen ties to all isopitched runs:
        ...
        ..  container:: example
            ...
            Attaches Messiaen tie to isopitched run 0:
            ...
            ::
                ...
                ...     'Voice 1',
                ...     [[0, 0, 10], [10, 16, 16, 18, 20], [9]],
                ...     baca.messiaen_ties(baca.select_isopitched_run()),
                ...     baca.rests_around([2], [4]),
                ...     baca.tuplet_bracket_staff_padding(5),
                ...     talea_counts=[1, 1, 5, -1],
                ...     time_treatments=[-1],
