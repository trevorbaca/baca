...
class MetronomeMarkSpanner(abjad.Spanner):
    r"""
    ...
    def _add_no_indicators(self, bundle, leaf):
        if leaf is self[0]:
            ...
            strings.append(r'- \baca_invisible_line_segment')
            override = LilyPondGrobOverride(
                grob_name='TextSpanner',
                property_path=(
                    'bound-details',
    ...
    def tests(self):
        r"""
        Wrappers copy alternate tagging triple.
    ...
    def tweaks(self) -> None:
        r"""
        Are not implemented on metronome mark spanner.

        ..  container:: example

            Override accelerando markup by hand to style ritardandi included in
            a metronome mark spanner:
        ...
        ..  container:: example
            ...
            Override ritardando markup by hand to style ritardandi included in
            a metronome mark spanner:
    ...
    def start_command(self) -> typing.List[str]:
        ...
        ..  container:: example
            ...
            >>> baca.MetronomeMarkSpanner().start_command()
            ['\\startTextSpan']
    ...
    def stop_command(self) -> typing.Optional[str]:
        ...
        ..  container:: example
            ...
            >>> baca.MetronomeMarkSpanner().stop_command()
            '\\stopTextSpan'
