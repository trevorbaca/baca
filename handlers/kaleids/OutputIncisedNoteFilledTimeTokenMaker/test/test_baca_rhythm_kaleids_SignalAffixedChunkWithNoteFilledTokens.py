...
def test_baca_rhythm_kaleids_OutputIncisedNoteFilledTimeTokenMaker_01():

    prefix_signal, prefix_lengths = [-8], [2]
    suffix_signal, suffix_lengths = [-3], [4]
    denominator = 32
    kaleid = OutputIncisedNoteFilledTimeTokenMaker(
...
def test_baca_rhythm_kaleids_OutputIncisedNoteFilledTimeTokenMaker_02():
...
def test_baca_rhythm_kaleids_OutputIncisedNoteFilledTimeTokenMaker_03():
...
def test_baca_rhythm_kaleids_OutputIncisedNoteFilledTimeTokenMaker_04():
...
def test_baca_rhythm_kaleids_OutputIncisedNoteFilledTimeTokenMaker_05():
