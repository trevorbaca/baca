from handlers.kaleids._SignalAffixedObjectWithFilledTokens import _SignalAffixedObjectWithFilledTokens


class _SignalAffixedChunkWithFilledTokens(_SignalAffixedObjectWithFilledTokens):
