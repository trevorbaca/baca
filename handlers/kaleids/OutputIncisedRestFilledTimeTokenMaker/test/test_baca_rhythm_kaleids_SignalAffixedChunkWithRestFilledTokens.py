...
def test_baca_rhythm_kaleids_OutputIncisedRestFilledTimeTokenMaker_01():

    prefix_signal, prefix_lengths = [8], [2]
    suffix_signal, suffix_lengths = [3], [4]
    denominator = 32
    kaleid = OutputIncisedRestFilledTimeTokenMaker(
...
def test_baca_rhythm_kaleids_OutputIncisedRestFilledTimeTokenMaker_02():
...
def test_baca_rhythm_kaleids_OutputIncisedRestFilledTimeTokenMaker_03():
...
def test_baca_rhythm_kaleids_OutputIncisedRestFilledTimeTokenMaker_04():
...
def test_baca_rhythm_kaleids_OutputIncisedRestFilledTimeTokenMaker_05():
