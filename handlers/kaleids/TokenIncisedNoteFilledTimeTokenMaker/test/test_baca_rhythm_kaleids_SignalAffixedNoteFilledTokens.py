...
def test_baca_rhythm_kaleids_TokenIncisedNoteFilledTimeTokenMaker_01():

    prefix_signal, prefix_lengths = [-8], [0, 1]
    suffix_signal, suffix_lengths = [-1], [1]
    denominator = 32
    kaleid = TokenIncisedNoteFilledTimeTokenMaker(
...
def test_baca_rhythm_kaleids_TokenIncisedNoteFilledTimeTokenMaker_02():
...
def test_baca_rhythm_kaleids_TokenIncisedNoteFilledTimeTokenMaker_03():
...
def test_baca_rhythm_kaleids_TokenIncisedNoteFilledTimeTokenMaker_04():
...
def test_baca_rhythm_kaleids_TokenIncisedNoteFilledTimeTokenMaker_05():
...
def test_baca_rhythm_kaleids_TokenIncisedNoteFilledTimeTokenMaker_06():

    prefix_signal, prefix_lengths = [-1], [1]
    suffix_signal, suffix_lengths = [], [0]
    denominator, prolation_addenda, secondary_divisions = 32, [2, 0], [20]
    kaleid = TokenIncisedNoteFilledTimeTokenMaker(prefix_signal, prefix_lengths,
