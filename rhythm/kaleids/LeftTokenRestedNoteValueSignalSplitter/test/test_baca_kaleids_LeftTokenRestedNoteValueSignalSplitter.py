...
def test_baca_kaleids_LeftTokenRestedNoteValueSignalSplitter_01( ):
   '''Fine note-value signal.
   '''

   nvs, denominator = [1], 16
   rested_splitter = LeftTokenRestedNoteValueSignalSplitter(nvs, denominator)
...
def test_baca_kaleids_LeftTokenRestedNoteValueSignalSplitter_02( ):
