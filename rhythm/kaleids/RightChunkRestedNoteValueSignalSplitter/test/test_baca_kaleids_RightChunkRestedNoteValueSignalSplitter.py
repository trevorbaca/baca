...
def test_baca_kaleids_RightChunkRestedNoteValueSignalSplitter_01( ):
   '''Fine note-value signal.
   '''

   nvs, denominator = [1], 16
   rested_splitter = RightChunkRestedNoteValueSignalSplitter(nvs, denominator)
...
def test_baca_kaleids_RightChunkRestedNoteValueSignalSplitter_02( ):
