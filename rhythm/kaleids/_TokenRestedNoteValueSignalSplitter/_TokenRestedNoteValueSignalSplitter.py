...
class _TokenRestedNoteValueSignalSplitter(NoteValueSignalSplitter):
   '''Token-rested note-value signal splitter.
   ...
   def __call__(self, duration_tokens, seeds = None):
      ...
      split_and_rested_note_value_signal = self._token_rest_split_and_scaled_note_value_signal(
