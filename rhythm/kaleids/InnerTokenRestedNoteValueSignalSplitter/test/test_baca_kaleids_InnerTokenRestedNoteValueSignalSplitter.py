...
def test_baca_kaleids_InnerTokenRestedNoteValueSignalSplitter_01( ):
   '''Fine note-value signal.
   '''

   nvs, denominator = [1], 16
   rested_splitter = InnerTokenRestedNoteValueSignalSplitter(nvs, denominator)
...
def test_baca_kaleids_InnerTokenRestedNoteValueSignalSplitter_02( ):
