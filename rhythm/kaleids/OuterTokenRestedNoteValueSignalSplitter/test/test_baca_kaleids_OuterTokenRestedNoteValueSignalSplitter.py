...
def test_baca_kaleids_OuterTokenRestedNoteValueSignalSplitter_01( ):
   '''Fine note-value signal.
   '''

   nvs, denominator = [1], 16
   rested_splitter = OuterTokenRestedNoteValueSignalSplitter(nvs, denominator)
...
def test_baca_kaleids_OuterTokenRestedNoteValueSignalSplitter_02( ):
