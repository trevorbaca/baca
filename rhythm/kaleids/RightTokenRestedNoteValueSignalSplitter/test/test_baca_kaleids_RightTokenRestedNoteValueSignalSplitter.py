...
def test_baca_kaleids_RightTokenRestedNoteValueSignalSplitter_01( ):
   '''Fine note-value signal.
   '''

   nvs, denominator = [1], 16
   rested_splitter = RightTokenRestedNoteValueSignalSplitter(nvs, denominator)
...
def test_baca_kaleids_RightTokenRestedNoteValueSignalSplitter_02( ):
