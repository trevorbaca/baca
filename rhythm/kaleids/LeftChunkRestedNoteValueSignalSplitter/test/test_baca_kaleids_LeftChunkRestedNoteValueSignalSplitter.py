...
def test_baca_kaleids_LeftChunkRestedNoteValueSignalSplitter_01( ):
   '''Fine note-value signal.
   '''

   nvs, denominator = [1], 16
   rested_splitter = LeftChunkRestedNoteValueSignalSplitter(nvs, denominator)
...
def test_baca_kaleids_LeftChunkRestedNoteValueSignalSplitter_02( ):
